...
class _ReviewsPageState extends State<ReviewsPage>
            ...
            Container(
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  _buildTabButton(1, '1 (2)'),
                  _buildTabButton(2, '2 (2)'),
                  _buildTabButton(3, '3 (2)'),
                  _buildTabButton(4, '4 (2)'),
                  _buildTabButton(5, '5 (2)'),
                ],
              ),
            ),
  ...
  ElevatedButton _buildTabButton(int tab, String text) {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        ...
        backgroundColor:
            (_selectedTab == tab) ? AppColor.primary : Colors.white,
        elevation: 0,
      ),
    );
  }
